...
[![Jenkins Status](https://img.shields.io/jenkins/s/https/ci-builds.apache.org/job/Maven/job/maven-box/job/maven-wrapper-plugin/job/master.svg)][build]
[![Jenkins tests](https://img.shields.io/jenkins/t/https/ci-builds.apache.org/job/Maven/job/maven-box/job/maven-wrapper-plugin/job/master.svg)][test-results]
...
[test-results]: https://ci-builds.apache.org/job/Maven/job/maven-box/job/maven-wrapper-plugin/job/master/lastCompletedBuild/testReport/
[build]: https://ci-builds.apache.org/job/Maven/job/maven-box/job/maven-wrapper-plugin/job/master/
